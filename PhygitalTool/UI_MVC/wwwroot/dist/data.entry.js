...
(() => {
/*!*******************************************!*\
  !*** ./src/ts/Statistic/dataFileMaker.ts ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
...
function sanitizeSheetName(name) {
    ...
    let sanitized = name.replace(illegalCharacters, '');
...
function excelFileMaker() {
    ...
    tables.forEach((table) => {
        const ws = xlsx__WEBPACK_IMPORTED_MODULE_0__.utils.table_to_sheet(table);
        const sanitizedSheetName = sanitizeSheetName(table.id);
        xlsx__WEBPACK_IMPORTED_MODULE_0__.utils.book_append_sheet(wb, ws, sanitizedSheetName);
    });
